...
public class MarketplaceUtil {
	...
	public static File addMarketplaceMetadata(
			File file, Map<String, Properties> propertiesMap, String fileName)
		throws IOException {

		Path tempDirectory = Files.createTempDirectory(
			"marketplace-temp-directory-");

		Path filePathWithMarketplaceMetadata = tempDirectory.resolve(fileName);
