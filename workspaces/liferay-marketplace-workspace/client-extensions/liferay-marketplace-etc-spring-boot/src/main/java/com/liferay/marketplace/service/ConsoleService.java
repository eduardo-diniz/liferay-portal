...
public class ConsoleService extends BaseService {
	...
	public void deleteProject(long orderId) throws Exception {
		ConsoleProjectContext context = _consoleProjectContextFactory.create(
			orderId);

		String projectName =
			context.getConsoleProjectPrefix() + "-ext" + orderId;
	...
	public void setUpProject(
		...
		JSONObject jsonObject = _postProject(
			orderId, context.getConsoleProjectPrefix() + "-ext" + orderId);
	...
	private void _linkDXPWithProject(
		...
		post(
			...
			new JSONObject(
				...
				"dxpProjectUid", context.getConsoleProjectUid()
			).put(
		...
		JSONObject jsonObject = new JSONObject(
			post(
				...
				new JSONObject(
					...
					"cluster", context.getConsoleCluster()
				).put(
					"environment", true
				).put(
					"metadata",
